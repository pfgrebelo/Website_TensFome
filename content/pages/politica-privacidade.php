<main class="container border mb-2 shadow-lg p-3"><!--CONTEUDO DA PAGINA-->
  <div class="m-5">
    ...
    <hr>
    <p>A sua privacidade é importante para nós. É política do Tens Fome? respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Tens Fome?, e outros sites que possuímos e operamos.</p>
    ...
    <h6>Pedidos processando cookies relacionados</h6>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Tens Fome? oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
    <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, onde apostar ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Tens Fome?, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    <br>
